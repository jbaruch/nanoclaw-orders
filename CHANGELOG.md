...
**Surface sync:** `skills/check-orders/scripts/fetch-order-emails.py` (the `QUERIES` constant + rationale comment). No SKILL.md change — the query strings live in the script per `coding-policy: script-as-black-box`.
